...
from constraints import (
    ...
    cruise_constraint, climb_constraint_vectorized,
...
print(f"Thrust-to-Weight   : {T_W_actual:.3f}")
...
print(f"Fuel/Passenger [lb]  : {fuel_per_pax:.2f}")
print(f"Total Fuel [lb]      : {fuel_total:.2f}")
print(f"T/W Actual           : {T_W_actual:.3f}")
print()
